...
function AchievementHandler:new()
    ...
    create("fifth miss", "Missed your fifth note...", "uncommon")
    create("tenth miss", "Missed your tenth note...", "rare")
    create("fiftieth miss", "Missed your fiftieth note...", "epic")
    create("hundredth miss", "Missed your hundredth note...", "legendary")
    create("two hundredth miss", "Missed your two hundredth note...", "mythical")
