Language = {
    ...
    Warnings = {
        ...
        ["Warning nochart"] = "This song has not been charted yet",
        ...
        ["Warning suicide"] = "Depictions of Suicide or Self Harm",  -- stole this wording from youtube's content warnings
