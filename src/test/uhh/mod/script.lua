...
thefuckingcanvas = love.graphics.newCanvas(1280,720)
	-- Variables
...
function scriptState:update(dt)
		dt = math.min(dt, 1 / 30)
...
function scriptState:draw()
	love.graphics.setFont(font)
		...
		love.graphics.setCanvas(thefuckingcanvas)
        ...
        baseScreenRatio.x / 1280,
        baseScreenRatio.y / 720
    )
