...
function titleScreen:enter()
    ...
    self.buttonLabels = {
        ...
        {label = LocaleHandler:getText("Menu", "Jukebox"), func = function() State.switch(States.menu.jukebox, self) end, color1 = {142/255,249/255,243/255,1},color2 = {88/255,246/255,238/255,1}},
