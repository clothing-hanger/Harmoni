...
if love.filesystem.exists("Settings.lua") then
    ...
    setDefaultSettings()local SettingsState = State()
    local AllDirections = {
        "Left",
        "Down",
        "Up",
...
Gameplay = {
    ...
    {"Bot Play", BotPlay},
    {"Note Lane Height", verticalNoteOffset, "test"}
}
...
function SettingsState:draw()
    ...
    if CurSettingsMenu == "Tabs" then
        ...
        love.graphics.setColor(1,1,1,1)
        love.graphics.rectangle("fill", 60, Inits.GameHeight-60, Inits.GameWidth-120, 50)
        love.graphics.setColor(0,1,1,1)

        love.graphics.rectangle("line", 60, Inits.GameHeight-60, Inits.GameWidth-120, 50)
        love.graphics.setColor(0,0,0,1)
        love.graphics.printf("PLACEHOLDER TEXT", 60, Inits.GameHeight-50, Inits.GameWidth-120, "center")
    elseif CurSettingsMenu == "Gameplay" then
        for i = 1,#Gameplay do
            if selectedSetting == i then
                love.graphics.setColor(0,0,0,0.9)
